    ...
    <div class="container">
        <div class="row">
            <div class="col-xxl-9 col-lg-8">
                <div class="th-blog blog-single"><a data-theme-color="#4E4BD0" href="blog.html"
                        class="category">Sports</a>
                    <h2 class="blog-title">Fuel your competitive spirit chase victory and Let sports be your legacy
                    </h2>
                    <div class="blog-meta"><a class="author" href="blog.html"><i class="far fa-user"></i>By -
                            Tnews</a> <a href="blog.html"><i class="fal fa-calendar-days"></i>21 June, 2023</a> <a
                            href="blog-details.html"><i class="far fa-comments"></i>Comments (3)</a> <span><i
                                class="far fa-book-open"></i>5 Mins Read</span></div>
                    <div class="blog-img"><img src="/client/demo/assets/img/blog/blog-s-1-5.jpg" alt="Blog Image"></div>
                        ...
                        <div class="blog-content">
                            ...
                            <div class="content">
                                <p>Fuel your competitive spirit, chase victory, and let sports be your legacy
                                    encapsulates the essence of embracing sports as a means to challenge oneself,
                                    strive for success, and leave a lasting impact. This phrase urges individuals to
                                    tap into their inner drive and motivation.</p>
                                ...
                                <div class="my-4 py-lg-2"><a
                                        href="https://themeforest.net/user/themeholy/portfolio"><img
                                            class="light-img w-100" src="/client/demo/assets/img/ads/ads_blog_1.jpg" alt="Ads">
                                        <img class="dark-img w-100" src="/client/demo/assets/img/ads/ads_blog_1_dark.jpg"
                                            alt="Ads"></a></div>
                                ...
                                <div class="my-4 py-lg-2"><img class="w-100" src="/client/demo/assets/img/blog/blog_inner_1.jpg"
                                        alt="Blog Image"></div>
                                ...
                                <div class="row mb-4 pb-lg-2 pt-xl-2 gy-4">
                                    <div class="col-md-auto">
                                        <div class=""><img class="w-100" src="/client/demo/assets/img/blog/blog_inner_2.jpg"
                                                alt="Blog Image"></div>
                                    </div>
                                    <div class="col-md">
                ...
                <div class="blog-navigation">
                    <div class="nav-btn prev">
                        <div class="img"><img src="/client/demo/assets/img/blog/blog-nav-1.jpg" alt="blog img" class="nav-img">
                        </div>
                    ...
                    <div class="nav-btn next">
                        ...
                        <div class="img"><img src="/client/demo/assets/img/blog/blog-nav-2.jpg" alt="blog img" class="nav-img">
                        </div>
                    </div>
                </div>
                <div class="blog-author">
                    <div class="auhtor-img"><img src="/client/demo/assets/img/blog/blog-author.jpg" alt="Blog Author Image">
                    </div>
                    <div class="media-body">
                    ...
                    <ul class="comment-list">
                        <li class="th-comment-item">
                            <div class="th-post-comment">
                                <div class="comment-avater"><img src="/client/demo/assets/img/blog/comment-author-1.jpg"
                            ...
                            <ul class="children">
                                <li class="th-comment-item">
                                    <div class="th-post-comment">
                                        <div class="comment-avater"><img src="/client/demo/assets/img/blog/comment-author-2.jpg"
                                                alt="Comment Author"></div>
                                        <div class="comment-content"><span class="commented-on"><i
                        ...
                        <li class="th-comment-item">
                            <div class="th-post-comment">
                                <div class="comment-avater"><img src="/client/demo/assets/img/blog/comment-author-3.jpg"
                                        alt="Comment Author"></div>
                                <div class="comment-content"><span class="commented-on"><i
            ...
            <div class="col-xxl-3 col-lg-4 sidebar-wrap">
                <aside class="sidebar-area">
                    ...
                    <div class="widget widget_categories">
                        ...
                        <ul>
                            <li><a data-bg-src="/client/demo/assets/img/bg/category_bg_1_1.jpg" href="blog.html">Sports</a></li>
                            <li><a data-bg-src="/client/demo/assets/img/bg/category_bg_1_2.jpg" href="blog.html">Business</a>
                            </li>
                            <li><a data-bg-src="/client/demo/assets/img/bg/category_bg_1_3.jpg" href="blog.html">Politics</a>
                            </li>
                            <li><a data-bg-src="/client/demo/assets/img/bg/category_bg_1_4.jpg" href="blog.html">Health</a></li>
                            <li><a data-bg-src="/client/demo/assets/img/bg/category_bg_1_5.jpg" href="blog.html">Technology</a>
                            </li>
                            <li><a data-bg-src="/client/demo/assets/img/bg/category_bg_1_6.jpg"
                        ...
                        <div class="recent-post-wrap">
                            <div class="recent-post">
                                <div class="media-img"><a href="blog-details.html"><img
                                            src="/client/demo/assets/img/blog/recent-post-1-1.jpg" alt="Blog Image"></a></div>
                                <div class="media-body">
                            ...
                            <div class="recent-post">
                                <div class="media-img"><a href="blog-details.html"><img
                                            src="/client/demo/assets/img/blog/recent-post-1-2.jpg" alt="Blog Image"></a></div>
                                <div class="media-body">
                            ...
                            <div class="recent-post">
                                <div class="media-img"><a href="blog-details.html"><img
                                            src="/client/demo/assets/img/blog/recent-post-1-3.jpg" alt="Blog Image"></a></div>
                                <div class="media-body">
                            ...
                            <div class="recent-post">
                                <div class="media-img"><a href="blog-details.html"><img
                                            src="/client/demo/assets/img/blog/recent-post-1-4.jpg" alt="Blog Image"></a></div>
                                <div class="media-body">
                    ...
                    <div class="widget">
                        <div class="widget-ads"><a href="https://themeforest.net/user/themeholy/portfolio"><img
                                    class="w-100" src="/client/demo/assets/img/ads/siderbar_ads_1.jpg" alt="ads"></a></div>
                    </div>
